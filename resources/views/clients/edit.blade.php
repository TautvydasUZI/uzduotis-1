    ...
    <div class="container py-3">
        ...
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
              <h1 class="display-4 fw-normal">Edit Client</h1>
          ...
          <form method="POST" action="{{route('client.update', [$client])}}">
            ...
            <input class="form-control" type="text" name="client_name" value="{{$client->name}}"/> <br/>
            <input class="form-control" type="text" name="client_surname" value="{{$client->surname}}"/> <br/>
            <input class="form-control" type="text" name="client_username" value="{{$client->username}}"/> <br/>
            <input class="form-control" type="text" name="client_company_id" value="{{$client->company_id}}"/> <br/>
            <input class="form-control" type="text" name="client_image" value="{{$client->image}}"/><br/>
