    ...
    <div class="container py-3">
        ...
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
              <h1 class="display-4 fw-normal">Edit Company</h1>
        ...
        <form method="POST" action="{{route('company.update', [$company])}}">
            ...
            <input class="form-control" type="text" name="type" value="{{$company->type}}" /> <br/>
            <input class="form-control" type="text" name="description" value="{{$company->description}}"/> <br/>
